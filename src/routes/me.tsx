...
function MePage() {
  return (
    <PhoneShell>
      ...
      >
        ...
        <div className="relative mt-5 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-white/85">Sphere Member · Gold</p>
      ...
      <section className="px-4 mt-4">
        <div className="rounded-2xl bg-gradient-to-r from-flame/15 to-orange-50 border border-flame/20 p-4 flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-[11px] text-muted-foreground">For every friend who joins Sphere</p>
          </div>
      ...
      <p className="text-center text-[10px] text-muted-foreground mt-6">Sphere · v1.0 · Made with ♡</p>
